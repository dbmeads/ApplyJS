...
describe('apply.Model', function () {
    ...
    it('should be able to create a 2nd mixed in constructor from apply.Model by calling apply.Model.compose()', function () {
        var NewModel = apply.Model.compose({prop1:'Model'});
    ...
    describe('crud', function () {
        it('should support a save method that will POST to a urlRoot if id is not defined', function () {
            ajaxSpy.setResult();
            var model = new (apply.Model.compose({urlRoot:'/users'}))({firstname:'Dave'});
        ...
        it('should support a save method that will PUT to urlRoot/{id} if id is defined', function () {
            ajaxSpy.setResult();
            var model = new (apply.Model.compose({urlRoot:'/users'}))({id:1, firstname:'Dave'});
        ...
        it('should support a destroy method that will DELETE a urlRoot/{id}', function () {
            ajaxSpy.setResult();
            var model = new (apply.Model.compose({urlRoot:'/users'}))({id:1});
